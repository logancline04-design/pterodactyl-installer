...
export PTERODACTYL_WINGS_VERSION="v1.11.13"
...
export WINGS_DL_BASE_URL="https://github.com/pterodactyl/wings/releases/download/v1.11.13/wings_linux_"
export MARIADB_URL="https://downloads.mariadb.com/MariaDB/mariadb_repo_setup"
export GITHUB_BASE_URL=${GITHUB_BASE_URL:-"https://raw.githubusercontent.com/logancline04-design/pterodactyl-installer"}
